...
# ---------------------------------------------------------------------------
# Author: LiaoChenchen
# Created on: 2020/8/19 15:42
# Reference: https://blog.csdn.net/wangzhenyang2/article/details/85106267
"""
Description:
Usage:
ERROR: 报错 应该是python2和python3差别引起的
"""
# ---------------------------------------------------------------------------
import cv2
...
path='G:/MoveOn/boomboost/test/'
queryPath=path+'tt/' #图库路径
samplePath=path+'1212.jpg' #样本图片
...
# print type(row) # <type 'float'>
# print type(column) # <type 'int'>
row = int(row)
#绘图显示
